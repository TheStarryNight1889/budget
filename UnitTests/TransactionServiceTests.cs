...
namespace UnitTests
{
    public class TransactionServiceTests
    {
        ...
        public async Task TransactionService_Updates_Wallet_New_Transaction()
        {
            ...
            TransactionModel transaction = new TransactionModel(user._id, wallet._id, 100, DateTime.UtcNow, api.Enums.TransactionCategory.Dental, "unit test", "Dentist", "Cavity repair");

            TransactionService service = new TransactionService();
            WalletModel newWallet = await service.UpdateWalletForNewTransaction(user, transaction);
        ...
        [Fact]
        public async Task TransactionService_Updates_Wallet_Updated_Transaction_Increase()
        {
            DateTime now = DateTime.UtcNow;
            ...
            TransactionModel oldTransaction = new TransactionModel(user._id, wallet._id, 10, DateTime.UtcNow, api.Enums.TransactionCategory.Automotive, "test", "test", "test");
            TransactionModel newTransaction = new TransactionModel(user._id, wallet._id, 20, DateTime.UtcNow, api.Enums.TransactionCategory.Automotive, "test", "test", "test");
        ...
        [Fact]
        public async Task TransactionService_Updates_Wallet_Updated_Transaction_Decrease()
        {
            DateTime now = DateTime.UtcNow;
        ...
        [Fact]
        public async Task TransactionService_Updates_Wallet_Deleted_Transaction()
        {
            DateTime now = DateTime.UtcNow;
